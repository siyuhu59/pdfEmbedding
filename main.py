...
def save_parsed_data_to_db(pdf_parser, embedding_Module:EmbeddingGenerator, db_name, division):
...
if __name__ == "__main__":
    ...
    # PDF 파싱 데이터 저장
    save_parsed_data_to_db(pdf_parser, embedding_Module, db_name, 0)
    save_parsed_data_to_db(pdf_parser, embedding_Module, db_name, 1)
